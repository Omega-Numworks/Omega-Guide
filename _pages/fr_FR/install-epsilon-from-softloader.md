...
La dernière version d'Epsilon pourrait ne pas être sûre, vérifiez la dernière version [ici](https://numvercheck.deno.dev/) (aucune connexion) ou [là uniquement pour n0110](https://my.numworks.com/firmwares/n0110/stable.json) (connexion au compte Numworks nécessaire). Dernière version sûre connue: **21.2.0**
