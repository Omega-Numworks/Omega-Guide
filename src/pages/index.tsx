    ...
    >
      ...
      <main>
        <div id="content" className='content-home'>
          <h2 id='cfw'><Translate id='home.page.cfw.title'>Custom OS?</Translate></h2>
          <p><Translate id='home.page.cfw.text1'>Custom OSes are software modifications for the NumWorks. They allow you to do anything that the NumWorks is physically capable of doing, rather than being limited by whatever NumWorks allows you to do.</Translate></p>
          <p><Translate id='home.page.cfw.text2'>Popular uses for custom OS include:</Translate></p>
          <ul>
            ...
            <li><Translate id='home.page.cfw.possibilities.4.part1'>Installing </Translate><a href="/docs/cfw/choose-a-cfw"><Translate id='home.page.cfw.possibilities.4.part2'>other custom OS</Translate></a><Translate id='home.page.cfw.possibilities.4.part3'>, like </Translate><a href="/docs/cfw/omega">Omega</a><Translate id='home.page.cfw.possibilities.4.part4'> or </Translate><a href="/docs/cfw/upsilon">Upsilon</a></li>
          </ul>
          ...
          <ul>
            ...
            <li><Translate id='home.page.whatContent.list.2'>Install a custom OS on your calculator</Translate></li>
          ...
          <ul>
            <li><Translate id='home.page.whatKnow.text1'>The techniques described in this guide are pretty much in their early stages. We are not responsible for anything that goes wrong with your device. There is a slight chance that you might brick it.</Translate></li>
