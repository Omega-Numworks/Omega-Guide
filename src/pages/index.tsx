    ...
    >
      ...
      <main>
        <div id="content" className='content-home'>
          ...
          <p><Translate id='home.page.cfw.text1'>Custom OSs are software modifications for the numworks. They allow you to do anything that the Numworks is physically capable of doing, rather than being limited by whatever Numworks allows you to do.</Translate></p>
