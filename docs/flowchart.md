...
flowchart TD
    ...
    click calc_locked_no_modif "./cannot-unlock/what-to-do-locked"
    ...
    click calc_locked_n0110 "./cannot-unlock/what-to-do-locked"
    ...
    click calc_locked_new_calcs "./cannot-unlock/what-to-do-locked"
```
